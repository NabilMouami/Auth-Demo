...
import login.authen.config.JWTTokenHelper;
import login.authen.entities.User;
import login.authen.requests.AuthenticationRequest;
import login.authen.responses.LoginResponse;
import login.authen.responses.UserInfo;
@RestController
...
public class AuthenticationController {
	...
	public ResponseEntity<?> login(@RequestBody AuthenticationRequest authenticationRequest) throws InvalidKeySpecException, NoSuchAlgorithmException {
		...
		response.setRoles(userObj.getAuthorities().toArray());
